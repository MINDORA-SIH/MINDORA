...
function Tag({ label, className }: { label: string; className: string }) {
  return (
    <span className={clsx("rounded-full border px-2 py-0.5 text-[12px] font-extrabold whitespace-nowrap", className)}>
      {label}
    </span>
  );
}
            ...
            >
              <div className="flex flex-wrap items-baseline justify-between gap-x-3 gap-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <TrendBadge changePercent={parameter.changePercent} direction={parameter.direction} />
                </div>
              </div>
