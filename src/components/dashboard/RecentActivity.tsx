...
export function RecentActivity({ sessions }: { sessions: SessionEntry[] }) {
  ...
  return (
    <SectionCard
      ...
      subtitle={t("dashboard.recentActivitySubtitle", "Individual sessions, most recent first")}
      icon={ClipboardList}
      tone="neutral"
    >
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  {session.dayLabel} · {session.timeLabel} · {session.minutes}{" "}
                  {t("dashboard.min", "min")}
                </p>
              </div>
              ...
              <div className="shrink-0 text-right">
                ...
                <p
                  className="mt-1 text-[12px] font-extrabold uppercase tracking-[0.08em]"
                  style={{ color: "var(--muted)" }}
                >
