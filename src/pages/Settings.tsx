  ...
  return (
    <div className="space-y-8 max-w-3xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Dark Mode Toggle */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border-4 border-pale-sky/40 shadow-sm flex items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <div className="bg-pale-sky/20 p-4 rounded-full">
              <Moon size={40} className="text-sky-blue" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-charcoal">Dark Mode</h2>
              <p className="text-xl text-charcoal/70">Make the screen darker</p>
            </div>
          </div>
          <button 
        ...
        {/* App Language */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border-4 border-lavender/40 shadow-sm flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-6">
            <div className="bg-lavender/20 p-4 rounded-full">
              <Globe size={40} className="text-lavender" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-charcoal">Language</h2>
              <p className="text-xl text-charcoal/70">Change app language</p>
            </div>
          </div>
        ...
        {/* Alerts Settings */}
        <div className="bg-white p-6 md:p-8 rounded-3xl border-4 border-soft-pink/40 shadow-sm flex items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-xl text-charcoal/70">Turn reminders on or off</p>
            </div>
          </div>
          <button 
