  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Personal Details */}
        <div
          className="rounded-[32px] p-8 border-4 border-lavender/30 shadow-sm hover:shadow-lg transition-shadow"
          style={{ backgroundColor: "var(--card-bg)" }}
        >
          <div className="flex items-center gap-4 mb-6">
            <div
              className="bg-sky-blue/30 p-4 rounded-full"
              style={{ color: "var(--foreground)" }}
            >
              <User size={40} />
            </div>
        ...
        {/* Medical Information */}
        <div
          className="rounded-[32px] p-8 border-4 border-rose-pink/30 shadow-sm hover:shadow-lg transition-shadow"
          style={{ backgroundColor: "var(--card-bg)" }}
        >
          <h3
          ...
          <div className="space-y-4">
            <div className="bg-rose-pink/10 p-4 rounded-2xl">
              <p
                className="text-[20px] font-bold tracking-wider mb-1"
                style={{ color: "var(--muted)" }}
              >
                Diagnosis
              </p>
        ...
        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            className="rounded-[32px] p-8 border-4 border-sky-blue/30 shadow-sm hover:shadow-lg transition-shadow"
            style={{ backgroundColor: "var(--card-bg)" }}
          >
            <h3
              className="text-2xl font-bold mb-6 flex items-center gap-2"
          ...
          <div
            className="rounded-[32px] p-8 border-4 border-red-200 shadow-sm hover:shadow-lg transition-shadow"
            style={{ backgroundColor: "var(--card-bg)" }}
          >
